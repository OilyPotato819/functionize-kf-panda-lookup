...
function searchClicked() {
  ...
  if (name === "po" || name === "dragon warrior") {
    ...
    updatePage("Master Mantis", "mantis", "We should hang out.");
    ...
    updatePage("Master Crane", "crane", "You can chain my body, but you will never chain my warrior spirit!");
    ...
    updatePage("Mr. Ping", "mr-ping", "We are noodle folk, broth runs through our veins!");
  } else {
...
function updatePage(characterName, imgName, quote) {
